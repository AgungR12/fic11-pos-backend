    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Comment create <i class="fas fa-comments text-primary"></i></h2>
                <div class="card">
                    <form action="{{ route('comments.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name_customer') is-invalid @enderror" name="name_customer" id="name_customer" placeholder="Nama Lengkap">
                                @error('name_customer')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                <label>Subjek</label>
                                <input type="text" class="form-control @error('subject') is-invalid @enderror" name="subject" id="subject" placeholder="Subjek">
                                @error('subject')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('message') is-invalid @enderror" placeholder="Comment" id="floatingTextarea" name="message"></textarea>
                                @error('message')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="type" value="pos" class="selectgroup-input" checked="">
