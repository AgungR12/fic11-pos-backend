...
@section('title', 'Superiority Event Create')
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Superiority Event create <i class="fas fa-book-open-reader text-primary"></i></h2>
                <div class="card">
                    <form action="{{ route('superiorityEvent.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
