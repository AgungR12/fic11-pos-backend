    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <h2 class="section-title">Order Detail <i class="fas fa-box-open text-primary"></i></h2>
                                    ...
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($orderItem as $item)
                                            <tr>
                                                ...
                                                <td class="text-capitalize">{{ $item->product->price }}</td>
                                                <td class="text-capitalize">{{ $item->quantity }}</td>
                                                <td class="text-capitalize">{{ $item->total_price }}</td>
                                            </tr>
                                        @endforeach
                                    </table>
                                </div>
